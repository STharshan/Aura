...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Took my car to aura autocare for a 2 step paint correction and ceramic coating and it's never looked better. Years of swirl marks and cheap car washes left it in a state but Aura have made the paint look brand new! Adam knows what he's doing and treated my car like his own. Highly recommend aura autocare for all your detailing needs.",
    name: "Harpal Sian",
  },
